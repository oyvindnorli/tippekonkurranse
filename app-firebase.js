...
async function refreshData() {
    ...
    try {
        ...
        const { cleanupOldFormatMatches } = await import('./js/utils/matchCache.js?v=20251118c');
...
async function cleanupOldMatchesInBackground() {
    try {
        ...
        const { cleanupAllOutdatedMatches } = await import('./js/utils/matchCache.js?v=20251118c');
