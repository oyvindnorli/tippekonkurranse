...
function renderOdds(odds) {
    ...
    return `
        <div class=”vm-odds”>
            <span class=”vm-odd-btn”>${odds.H ? odds.H.toFixed(2) : '-'}</span>
            <span class=”vm-odd-btn”>${odds.U ? odds.U.toFixed(2) : '-'}</span>
            <span class=”vm-odd-btn”>${odds.B ? odds.B.toFixed(2) : '-'}</span>
        </div>
    `;
}
